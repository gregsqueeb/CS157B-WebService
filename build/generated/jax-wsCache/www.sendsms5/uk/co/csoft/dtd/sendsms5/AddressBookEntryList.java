 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://www.csoft.co.uk/dtd/sendsms5.xsd}AddressBookEntry" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AddressBookEntryList {
    ...
    protected List<AddressBookEntry> item;
     ...
     * 
     */
    public List<AddressBookEntry> getItem() {
        if (item == null) {
            item = new ArrayList<AddressBookEntry>();
        }
        return this.item;
    }
